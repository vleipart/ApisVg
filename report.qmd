...
full_tab <- full_tab |> mutate(region = case_match(apiary,
    ...
    c("FN", "SW", "RN", "CS", "DK", "IR", "PL", "TX", "FR") ~ "Brownbee",
    c("SL", "IT", "PO", "MK", "MT", "TR") ~ "South Europe"
    ))
...
We will also separate haplotypes by apiary and visualize them as before.
...
We also calculate the distances between pairs of apiaries as the
average distance between haplotypes taken from different apiaries.
